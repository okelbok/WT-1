...
const astroAPI_ID = "3b503056-bb94-49ac-994e-2759ab2ed96b";
const astroAPI_Secret = "6640d5b945c753b5c9c8ee87b83d8c4dd11251463e736635b84295a911cc3ae30f9cb6c81eef2fc84cabc61795156ea5a6582b9e5b823fb761088242669766e59bb4e9167ce38a0180cc4656d275f699927fe8de4f3a1d3ed537bea714ea45c193ef0238ffc2138aa2451f120acb11b3";

const catAPI_KEY = "live_6K17X0Fcjc7bdcDyOAUgBf73sNmSqAw6VQJquRGjnW8zyKnEG0NhQOElAINKU7Bg";
const astroAPI_KEY = "Basic " + btoa(`${astroAPI_ID}:${astroAPI_Secret}`);
...
function createCard(bodyName, bodyInfo, index) {
    ...
    bodyImage.setAttribute("src", pictures[index]);
...
function changeAttributes(isApplied) {
    if (isApplied) {
        ...
        catImage.setAttribute("src", "images/cat.gif");
    }
    else {
